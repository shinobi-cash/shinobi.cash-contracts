...
/**
 * @title DiamondWithdrawalPaymaster
 ...
 */
contract DiamondWithdrawalPaymaster is BasePaymaster {
    ...
    function withdraw(
        ...
        if (!_validateWithdrawProof(withdrawal, proof, scope)) revert WithdrawalValidationFailed();
