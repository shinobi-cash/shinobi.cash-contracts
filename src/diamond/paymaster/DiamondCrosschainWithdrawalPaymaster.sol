...
/**
 * @title DiamondCrosschainWithdrawalPaymaster
 ...
 */
contract DiamondCrosschainWithdrawalPaymaster is BasePaymaster {
    ...
    function crosschainWithdraw(
        ...
        if (_withdrawal.processooor != address(POOL_DIAMOND)) revert InvalidProcessooor();
        ...
        if (!_validateCrosschainWithdrawProof(_withdrawal, _proof, scope)) {
