 ...
 * @notice ERC-4337 Paymaster for cross-chain Withdraw2 (2:1 merge) and refunds via ShinobiPool
...
contract CrosschainWithdraw2Paymaster is BasePaymaster {
    ...
    function crosschainWithdraw2(
        ...
        if (!_validateCrosschainWithdraw2Proof(abi.encode(data), proof, scope)) {
