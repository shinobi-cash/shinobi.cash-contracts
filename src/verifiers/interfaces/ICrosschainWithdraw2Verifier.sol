 ...
 *      Cross-chain version includes refundCommitment for recovery (12 signals).
 */
interface ICrosschainWithdraw2Verifier {
     ...
     *        [0] newCommitment    - Change output commitment
     *        [1] nullifierHash0       - Input 0 nullifier (spent)
     *        [2] nullifierHash1       - Input 1 nullifier (spent)
     *        [3] refundCommitment - Cross-chain refund commitment
