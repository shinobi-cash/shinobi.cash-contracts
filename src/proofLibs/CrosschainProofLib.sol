 ...
 *      [0] newCommitment    - Output: new commitment after withdrawal
 *      [1] existingNullifierHash - Output: spent nullifier
 *      [2] refundCommitment - Output: commitment for refund (with netRefundAmount)
...
library CrosschainProofLib {
    ...
    function newCommitment(CrosschainWithdrawProof memory _p) internal pure returns (uint256) {
    ...
    function refundCommitment(CrosschainWithdrawProof memory _p) internal pure returns (uint256) {
